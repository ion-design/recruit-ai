"use client";
// ion/Tag: Generated with Ion on 2/10/2024, 12:52:40 PM
      ...
      return (
         <button
            ...
            className={clsx(
               ...
               "flex w-fit flex-row items-center justify-center gap-x-1 rounded-lg border px-3 py-2 text-sm font-semibold leading-none transition-all",
               className
            )}
            {...props}
         >
