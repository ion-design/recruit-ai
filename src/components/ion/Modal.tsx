'use client';
// ion/Modal: Generated with Ion on 2/12/2024, 11:21:58 AM
...
>(({ className, children, ...props }, ref) => (
	<ModalPortal>
		...
		<ModalPrimitive.Content
			ref={ref}
			className={clsx(
				'shadow-high fixed left-[50%] top-[50%] z-50 grid w-fit translate-x-[-50%] translate-y-[-50%] rounded-radius-lg border border-none bg-background duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]',
				className
			)}
			{...props}
		>
...
>(
	(
		...
		<ModalPrimitive.Root {...props}>
			...
			<ModalContent ref={ref} className={clsx('max-w-lg overflow-hidden', className)}>
				{showClose && (
