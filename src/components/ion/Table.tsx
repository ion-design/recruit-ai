'use client';
// ion/TableContainer: Generated with Ion on 2/10/2024, 12:29:11 PM
...
>(({ className, ...props }, ref) => (
	<thead
		ref={ref}
		className={clsx('border-soft-stroke bg-weak [&>tr]:border-b-0', className)}
		{...props}
	/>
));
...
export default function Table<TData, TValue>({
	...
	return (
		...
		>
			<div>
				<TableRoot className={'w-full' + bordered ? 'border' : ''}>
